...
leanes-server is LeanES application as server example.
...
`docker: Got permission denied while trying to connect to the Docker server socket at unix:///var/run/docker.sock: Post http://%2Fvar%2Frun%2Fdocker.sock/v1.40/containers/create?name=spawebclient: dial unix /var/run/docker.sock: connect: permission denied.`
